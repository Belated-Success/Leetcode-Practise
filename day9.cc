...
//     char data[15];
//     int option=0,count_n=0, n=0;
//     // initial marks allocated to every students at starting-->
...
//     for(int i=0; i< getline(f,line); ++i){
//         count_n++;
//     }

//     while(option !=6){
//         // for printing all available option in database
//         cout<<"\nAvailable operation: \n1. Add New "
//               "Students \n2."
//             <<"Student Login\n3. Facalty Login\n4. "
//               "Proctor Login\n5. Admin View\n"
